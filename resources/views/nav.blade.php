<div class="items-center block w-auto max-h-fit overflow-auto h-fit grow basis-full">
    ...
    <ul class="flex flex-col pl-0 mb-0">
        ...
        <li class="w-full mt-4">
            <h6 class="pl-6 ml-2 font-bold leading-tight uppercase text-xs opacity-100">Facturación</h6>
        </li>

        <li class="mt-0.5 w-full">
            <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                href="{{ route('metodo.pagos') }}">
                <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Metodo de pago</span>
            </a>
        </li>
        @can('cliente.suscripcion')
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                    href="{{ route('suscripcion') }}">
        ...
        @can('suscripcion')
            <ul class="flex flex-col pl-0 mb-0">
                <li class="w-full mt-4">
                    <h6 class="pl-6 ml-2 font-bold leading-tight uppercase text-xs opacity-100">Account pages</h6>
                </li>
