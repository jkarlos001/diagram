        ...
        <div
            ...
            <div class="fixed w-full flex items-center justify-between h-14 text-white z-10">
                <div
                    ...
                    <span class="hidden md:block">Template Tailwind</span>
                </div>
            ...
            <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
                            ...
                            <table class="w-full">
                                <thead>
                                    <tr
                                        ...
                                        <th class="px-4 py-3">Clientxxxd</th>
                                    ...
                                    <tr
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center text-sm">
                                                <div
                                                    class="EfectoJCST relative hidden w-8 h-8 mr-3 rounded-full md:block">
                        ...
                        <form class="p-6 flex flex-col justify-center">
                            <div class="flex flex-col">
                                ...
                                <input type="text" name="name" id="name" placeholder="Full Name"
                                    class="Myinput" pattern="[a-z]*" />
                                {{-- w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none" --}}
                            </div>
                ...
                <div class="mt-8 mx-4">
                                    ...
                                    <div class="flex flex-wrap -mx-3">
                                        <div class="max-w-full px-3 lg:w-1/2 lg:flex-none">
                                            <div class="flex flex-col h-full">
                                                ...
                                                <p class="mb-12">From colors, cards, typography to complex elements,
                                                    you
                                    ...
                                    <div class="w-full max-w-full px-3 mb-6 md:w-6/12 md:flex-none xl:mb-0 xl:w-3/12">
                                        <div
                                            ...
                                            <div class="flex-auto px-1 pt-6">
                                                ...
                                                <p class="mb-6 leading-normal text-sm">As Uber works through a huge
                                                    amount of internal management turmoil.</p>
                                    ...
                                    <div class="w-full max-w-full px-3 mb-6 md:w-6/12 md:flex-none xl:mb-0 xl:w-3/12">
                                        <div
                                            ...
                                            <div class="flex-auto px-1 pt-6">
                                                ...
                                                <p class="mb-6 leading-normal text-sm">Music is something that every
                                                    person has his or her own specific opinion about.</p>
                                                <div class="flex items-center justify-between">
                                                    <button type="button"
                                                        class="inline-block px-8 py-2 mb-0 font-bold text-center uppercase align-middle transition-all bg-transparent border border-solid rounded-lg shadow-none cursor-pointer leading-pro ease-soft-in text-xs hover:scale-102 active:shadow-soft-xs tracking-tight-soft border-fuchsia-500 text-fuchsia-500 hover:border-fuchsia-500 hover:bg-transparent hover:text-fuchsia-500 hover:opacity-75 hover:shadow-none active:bg-fuchsia-500 active:text-white active:hover:bg-transparent active:hover:text-fuchsia-500">View
                                                        Project</button>
                    ...
                    {{-- solo la tarjeta --}}
                    <div
                        class="px-4 py-1 border-0 shadow-blur rounded-2xl bg-white bg-clip-border backdrop-blur-2xl backdrop-saturate-200">
                    <div class="flex flex-wrap -mx-3">
                                ...
                                <div
                                    ...
                                    <div class="relative right-0">
                                        <ul class="relative flex flex-wrap p-1 list-none bg-transparent rounded-xl"
                                            ...
                                            <li class="z-30 flex-auto text-center">
                                                <a class="z-30 block w-full px-0 py-1 mb-0 transition-all border-0 rounded-lg ease-soft-in-out bg-inherit text-slate-700"
                                                    nav-link active href="javascript:;" role="tab"
                                                    aria-selected="true">
                                            ...
                                            <li class="z-30 flex-auto text-center">
                                                <a class="z-30 block w-full px-0 py-1 mb-0 transition-all border-0 rounded-lg ease-soft-in-out bg-inherit text-slate-700"
                                                    nav-link href="javascript:;" role="tab"
                                                    aria-selected="false">
                                                    <svg class="text-slate-700" width="16px" height="16px"
