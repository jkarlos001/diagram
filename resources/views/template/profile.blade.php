...
<body class="m-0 font-sans antialiased font-normal text-base leading-default bg-gray-50 text-slate-500">
    <aside
        ...
        <div class="h-19.5">
            ...
            <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="{{ route('dashboard') }}">
                ...
                <img src="../assets/img/logo-ct.png"
                    ...
                    alt="main_logo" />
                <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">E-Commerce
                    Fotografico</span>
            </a>
        </div>
        ...
        <div class="items-center block w-auto">
            <ul class="flex flex-col pl-0 mb-0">
                ...
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                        ...
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Planes</span>
                    </a>
                </li>
                ...
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                        ...
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Roles y
                            Permisos</span>
                    </a>
                </li>
                ...
                {{-- <nav>
                    ...
                    <ol class="flex flex-wrap pt-1 pl-2 pr-4 mr-12 bg-transparent rounded-lg sm:mr-16">
                        <li class="leading-normal text-sm">
                            <a class="opacity-50" href="javascript:;">Pages2</a>
                        </li>
...
<script>
    function toggleSelection(event) {
        ...
        // Obtener el estado actual de selección del div
        var isSelected = clickedDiv.getAttribute("data-selected");

        // Si el div no está seleccionado, seleccionarlo
        if (isSelected === "false") {
            clickedDiv.classList.add("selected");
            clickedDiv.setAttribute("data-selected", "true");
        } else {
            // Si el div ya está seleccionado, deseleccionarlo
            clickedDiv.classList.remove("selected");
            clickedDiv.setAttribute("data-selected", "false");
        }
    }
</script>
